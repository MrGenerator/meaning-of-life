...
// Использует стабильный SDK: @google/genai
...
Пиши на русском, тепло, глубоко и персонально. Избегай банальностей. Используй жирный текст для ключевых понятий.`;
    ...
    // Используем gemini-1.5-flash, чтобы избежать ошибки 429 (Resource Exhausted)
    // Название модели указываем БЕЗ префикса 'models/', чтобы избежать ошибки 404
